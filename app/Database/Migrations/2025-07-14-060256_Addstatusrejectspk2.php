...
class Addstatusrejectspk2 extends Migration
{

    public function up()
    {
        // Ubah kolom status ENUM dari ['belum', 'sudah'] menjadi ['belum', 'sudah', 'approved']
        $this->db->query("ALTER TABLE estimasi_spk MODIFY status ENUM('belum', 'sudah', 'approved','Ditolak') NOT NULL DEFAULT 'belum'");
    }
