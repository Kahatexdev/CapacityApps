...
$routes->group('/planning', ['filter' => 'planning'], function ($routes) {
    ...
    $routes->get('warehouse/filterSisaPakaiNylon', 'MaterialController::filterSisaPakaiNylon');
    ...
    $routes->get('warehouse/filterSisaPakaiSpandex', 'MaterialController::filterSisaPakaiSpandex');
    ...
    $routes->get('warehouse/filterSisaPakaiKaret', 'MaterialController::filterSisaPakaiKaret');
