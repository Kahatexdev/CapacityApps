...
class ReturController extends BaseController
{
    ...
    public function index($area)
    {
        ...
        $url = 'http://127.0.0.1/MaterialSystem/public/api/getKategoriRetur';
        ...
        $listRetur = 'http://127.0.0.1/MaterialSystem/public/api/listRetur/' . $area;
    ...
    public function dataRetur($area)
    {
        ...
        $apiUrlPph = 'http://127.0.0.1/MaterialSystem/public/api/pph?model=' . urlencode($noModel);
        $apiUrlPengiriman = 'http://127.0.0.1/MaterialSystem/public/api/getPengirimanArea?noModel=' . urlencode($noModel);
    ...
    public function pengajuanRetur($area)
    {
        ...
        try {
            $materialUrl = 'http://127.0.0.1/MaterialSystem/public/api/cekMaterial/' . $postData['material'];
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            try {
                $resp = $client->post('http://127.0.0.1/MaterialSystem/public/api/saveRetur', [
                    'headers' => [
    ...
    public function listdataReturArea()
    {
        ...
        if (!empty($area)) {
            $listReturUrl = 'http://127.0.0.1/MaterialSystem/public/api/listRetur/' . $area . '?tglBuat=' . $tglRetur;
            $ch = curl_init();
    ...
    public function listRetur($area)
    {
        ...
        $listRetur = 'http://127.0.0.1/MaterialSystem/public/api/listRetur/' . $area . '?noModel=' . $noModel . '&tglBuat=' . $tglBuat;
        $res = file_get_contents($listRetur);
        $list = json_decode($res, true);
        $listRetur = $list['listRetur'] ?? [];
