...
class ReturController extends BaseController
{
    ...
    public function index($area)
    {
        ...
        $listRetur = 'http://172.23.39.117/MaterialSystem/public/api/listRetur/' . $area;
    ...
    public function pengajuanRetur($area)
    {
        ...
        $materialUrl = 'http://172.23.39.117/MaterialSystem/public/api/cekMaterial/' . $postData['material'];
        ...
        try {
            ...
            $response = $client->post('http://172.23.39.117/MaterialSystem/public/api/saveRetur', [
                'headers' => [
    ...
    public function listRetur($area)
    {
        ...
        $listRetur = 'http://172.23.39.117/MaterialSystem/public/api/listRetur/' . $area . '?noModel=' . $noModel . '&tglBuat=' . $tglBuat;
        $res = file_get_contents($listRetur);
        $list = json_decode($res, true);
