...
class MaterialController extends BaseController
{
    ...
    public function filterstatusbahanbaku($model)
    {
        ...
        $apiUrl = 'http://172.23.39.117/MaterialSystem/public/api/statusbahanbaku/' . $model . '?search=' . urlencode($search);
    ...
    public function cekBahanBaku($id, $idpln)
    {
        ...
        $apiUrl = 'http://172.23.39.117/MaterialSystem/public/api/cekBahanBaku/' . $model['model'];
        // Ambil data dari API
        $response = file_get_contents($apiUrl);
        $status = json_decode($response, true);
        // dd($status);
    ...
    public function cekStok()
    {
        ...
        $apiUrl = 'http://172.23.39.117/MaterialSystem/public/api/cekStok/' . $model;
        $response = file_get_contents($apiUrl);
    ...
    public function cekStokStyle()
    {
        ...
        $apiUrl = 'http://172.23.39.117/MaterialSystem/public/api/cekStok/' . $model . '/' . $style;
        $response = file_get_contents($apiUrl);
        $stok = json_decode($response, true);
    ...
    public function getMU($model, $styleSize, $area, $qtyOrder)
    {
        ...
        $apiUrl = 'http://172.23.39.117/MaterialSystem/public/api/getMU/' . $model . '/' . $styleSize . '/' . $area;
    ...
    public function listPemesanan($area)
    {
        ...
        $rawList = $this->fetchApiData("http://172.23.39.117/MaterialSystem/public/api/listPemesanan/{$area}");
        if (!is_array($rawList)) {
        ...
        foreach ($dataList as $key => $order) {
            ...
            if (isset($order['no_model'], $order['item_type'], $order['kode_warna'])) {
                $styleApiUrl = 'http://172.23.39.117/MaterialSystem/public/api/getStyleSizeByBb?no_model='
                ...
                if ($styleList) {
                    ...
                    foreach ($styleList as $style) {
                        if (isset($style['no_model'], $style['style_size'], $style['gw'], $style['composition'], $style['loss'])) {
                            ...
                            $tambahanApiUrl = 'http://172.23.39.117/MaterialSystem/public/api/getKgTambahan?no_model='
                ...
                $pengirimanApiUrl = 'http://172.23.39.117/MaterialSystem/public/api/getTotalPengiriman?area=' . $area . '&no_model='
                    . $order['no_model'] . '&item_type=' . urlencode($order['item_type']) . '&kode_warna=' . urlencode($order['kode_warna']);
    ...
    public function filterStockBahanBaku($area)
    {
        ...
        // Jika search ada, panggil API eksternal dengan query parameter 'search'
        $apiUrl = 'http://172.23.39.117/MaterialSystem/public/api/stockbahanbaku/' . $area . '?noModel=' . urlencode($noModel) . '&warna=' . urlencode($warna);
    ...
    public function requestAdditionalTime()
    {
        ...
        // Jika search ada, panggil API eksternal dengan query parameter 'search'
        $apiUrl = 'http://172.23.39.117/MaterialSystem/public/api/requestAdditionalTime/' . $area . '?jenis=' . urlencode($jenis) . '&tanggal_pakai=' . urlencode($tanggal_pakai);
    ...
    public function filterPPH($area)
    {
        ...
        // Jika search ada, panggil API eksternal dengan query parameter 'search'
        $apiUrl = 'http://172.23.39.117/MaterialSystem/public/api/pph?model=' . urlencode($noModel);
    ...
    public function getDataPerhari($area)
    {
        ...
        foreach ($data as $prod) {
            ...
            $apiUrl = 'http://172.23.39.117/MaterialSystem/public/api/pphperhari?model=' . urlencode($prod['mastermodel']) . '&size=' . urlencode($prod['size']);
    ...
    {
        $detail = [];
        $apiUrl = 'http://172.23.39.117/MaterialSystem/public/api/poTambahanDetail/' . $noModel . '/' . $area;
    ...
    public function savePoTambahan($area)
    {
        ...
        $payload = ['items' => $items];
        $apiUrl = 'http://172.23.39.117/MaterialSystem/public/api/savePoTambahan';
    ...
    public function filterTglPakai($area)
    {
        ...
        $apiUrl = "http://172.23.39.117/MaterialSystem/public/api/filterTglPakai/"
            . $area
    ...
    public function reportPemesanan($area)
    {
        ...
        $dataList = fetchApiData("http://172.23.39.117/MaterialSystem/public/api/listPemesanan/$area");
    ...
    public function getNomodel()
    {
        ...
        if ($poTambahan == 1) {
            // Jika search ada, panggil API eksternal dengan query parameter 'search'
            $apiUrl = 'http://172.23.39.117/MaterialSystem/public/api/getNoModelByPoTambahan?area=' . $area;
    ...
    public function getStyleSizeByNoModelPemesanan()
    {
        ...
        if ($poTambahan == 1) {
            // Jika search ada, panggil API eksternal dengan query parameter 'search'
            $apiUrl = 'http://172.23.39.117/MaterialSystem/public/api/getStyleSizeByPoTambahan?no_model=' . $noModel . '&area=' . $area;
    ...
    public function sisaKebutuhanArea($area)
    {
        ...
        if (!empty($area) && !empty($noModel)) {
            ...
            $pemesananUrl  = 'http://172.23.39.117/MaterialSystem/public/api/getPemesananByAreaModel?area=' . $area . '&no_model=' . urlencode($noModel);
            $pemesananResponse = file_get_contents($pemesananUrl);
            $dataPemesanan   = json_decode($pemesananResponse, true);

            $returUrl  = 'http://172.23.39.117/MaterialSystem/public/api/getReturByAreaModel?area=' . $area . '&no_model=' . urlencode($noModel);
        ...
        foreach ($dataPemesanan as $key => $pemesanan) {
            ...
            $urlStyle = 'http://172.23.39.117/MaterialSystem/public/api/getStyleSizeByBb?no_model=' . $pemesanan['no_model']
            ...
            foreach ($getStyle as $i => $data) {
                ...
                $PoPlus = 'http://172.23.39.117/MaterialSystem/public/api/getKgPoTambahan?no_model=' . $pemesanan['no_model']
                    . '&item_type=' . urlencode($pemesanan['item_type'])
                    . '&area=' . $area;
        ...
        foreach ($dataRetur as $retur) {
            // ambil data styleSize by bb
            $urlStyle = 'http://172.23.39.117/MaterialSystem/public/api/getStyleSizeByBb?no_model=' . $retur['no_model']
            ...
            foreach ($getStyle as $i => $data) {
                ...
                // Ambil kg po tambahan
                $PoPlus = 'http://172.23.39.117/MaterialSystem/public/api/getKgPoTambahan?no_model=' . $retur['no_model']
                    . '&item_type=' . urlencode($retur['item_type'])
                    . '&area=' . $area;
