...
class MaterialController extends BaseController
{
    ...
    public function filterstatusbahanbaku($model)
    {
        ...
        $apiUrl = 'http://127.0.0.1/MaterialSystem/public/api/statusbahanbaku/' . $model . '?search=' . urlencode($search);
    ...
    public function listPemesanan($area)
    {
        ...
        if (empty($tglPakai) && empty($pdk)) {
            ...
            $message = null;
            $rawList = $this->fetchApiData("http://127.0.0.1/MaterialSystem/public/api/listPemesanan/{$area}");
            if (!is_array($rawList)) {
    ...
    public function reportPemesanan($area)
    {
        ...
        $dataList = fetchApiData("http://127.0.0.1/MaterialSystem/public/api/listReportPemesanan/$area");
