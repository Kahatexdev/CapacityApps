            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $active4 ?> " href="<?= base_url($role . '/datadeffect') ?>">
                        ...
                        <span class="nav-link-text ms-1">Data Deffect Stocklot</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $active4 ?> " href="<?= base_url($role . '/bsmesin') ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                        ...
                        <span class="nav-link-text ms-1">Data Bs Mesin</span>
                    </a>
                </li>
                <li class="nav-item">
