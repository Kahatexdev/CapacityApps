    ...
    <div class="row">
                                ...
                                <tbody>
                                    <?php foreach ($tampildata as $order) : ?>
                                        <tr>
                                            ...
                                            <td class="text-sm">
                                                <button type="button" class="btn btn-success btn-sm edit-btn" data-toggle="modal" data-target="#EditModal" data-id="<?= $order['id']; ?>" data-area="<?= $order['needle']; ?>" data-total="<?= $order['production_unit']; ?>" >
                                                    Edit
                                                </button>
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-danger btn-sm delete-btn" data-toggle="modal" data-target="#ModalDelete" data-id="<?= $order['id']; ?>">
                                                    Delete
                                                </button>
                                            </td>
                                        </tr>
        ...
        <div class="modal fade  bd-example-modal-lg" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="modaldelete" aria-hidden="true">
            <div class="modal-dialog  modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Hapus Data Cylinder</h5>
                        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.edit-btn').click(function() {
                    ...
                    $('#ModalEdit').find('form').attr('action', '<?= base_url('capacity/updatemesinperjarum/') ?>' + id);
