                        ...
                        <form
                            ...
                            <div class="col-auto">
                                ...
                                <input
                                    ...
                                    id="dateInput"
                                    name="tgl_pakai"
                                    value="<?= esc($filter_tgl ?? old('tgl_pakai')) ?>">
                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '.update-btn', function() {
            ...
            $.ajax({
                url: 'http://127.0.0.1/MaterialSystem/public/api/getUpdateListPemesanan', // Ganti dengan URL endpoint
                method: 'POST',
                data: {
                    area: area,
                    tgl_pakai: tglPakai,
        ...
        document.getElementById('updatePemesanan').addEventListener('submit', function(event) {
            ...
            const BASE_URL = "http://127.0.0.1/CapacityApps/public/";
            ...
            fetch('http://127.0.0.1/MaterialSystem/public/api/updateListPemesanan', {
                    method: 'POST',
                    headers: {
