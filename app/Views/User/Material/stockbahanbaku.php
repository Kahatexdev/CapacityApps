...
<script>
    $(document).ready(function() {
        $('#filter_data').click(function(e) {
            ...
            $.ajax({
                url: "http://172.23.39.117/MaterialSystem/public/api/warehouse/search",
                method: "POST",
                dataType: "json",
                data: {
                    noModel,
        ...
        $('#export_excel').on('click', function() {
            ...
            window.location.href = "http://172.23.39.117/MaterialSystem/public/api/warehouse/exportExcel" + query;
