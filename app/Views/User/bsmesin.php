                ...
                <div class="card pb-0">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2 ms-auto">
                            <a href="http://127.0.0.1/CapacityApps/public/templateExcel/Template Form Input BS MC.xlsx" target="_blank" class="btn btn-success"><i class="fa fa-download"></i> Download Template</a>
...
<script type="text/javascript">
    ...
    function getInfo() {
        ...
        if (id) {
            fetch(`http://127.0.0.1/HumanResourceSystem/public/api/karyawan/${id}`)
                .then(response => {
                    if (!response.ok) {
