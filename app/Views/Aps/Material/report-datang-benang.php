...
<script>
    $(document).ready(function() {
        ...
        function loadData() {
            ...
            $.ajax({
                url: "<?= base_url($role . '/filterDatangBenang') ?>",
                type: "GET",
                data: {
                    key: key,
        ...
        $('#btnExport').click(function() {
            ...
            window.location.href = "<?= base_url($role . '/exportDatangBenang') ?>?key=" + key + "&tanggal_awal=" + tanggal_awal + "&tanggal_akhir=" + tanggal_akhir;
        });
