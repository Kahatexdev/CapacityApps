...
<script>
    ...
    document.getElementById('filterButton').addEventListener('click', function() {
        const area = '<?= $area ?>';
        const filterArea = document.getElementById('area').value.trim();
        ...
        const url = `<?= base_url($role . "/sisaKebutuhanArea") ?>/${area}?filter_model=${encodeURIComponent(filterModel)}&filter_area=${encodeURIComponent(filterArea)}`;
        // Redirect
