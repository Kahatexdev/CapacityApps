                    ...
                    <tbody>
                        <?php foreach ($tampildata as $order) : ?>
                            <tr>
                                ...
                                <td><?= $order->qty; ?></td>
                                <td><?= $order->sisa; ?></td>
                                <td><button type="button" class="btn btn-info btn-sm import-btn" data-toggle="modal" data-target="#importModal" data-id="<?= $order->id_model; ?>" data-no-model="<?= $order->no_model; ?>">
                                        Detail
                                    </button></td>
                                <td></td>
                            </tr>
    ...
    <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url($role . '/importModel') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
