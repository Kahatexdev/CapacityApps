                    ...
                    <div class="row" id="global">
                        <div class="col-lg-4">
                            ...
                            <div class=" form-group">
                                ...
                                <input type="text" id="globalmc" value=" <?= $summary['total_mc'] ?>  "
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="globalplanning" value="<?= $summary['planning_mc'] ?> "
                                    class="form-control" readonly>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="ttlmcsocks" value="<?= $summary['mc_socks'] ?> "
                                    class="form-control" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="ttlplanningsocks" value="<?= $summary['plan_mc_socks'] ?> "
                                    class="form-control" readonly>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="ttlmcgloves" value="<?= $summary['mc_gloves'] ?> "
                                    class="form-control" readonly>
                            </div>
                            <div class="form-group">
                                <label for="">
                                ...
                                <input type="text" id="ttlplanninggloves" value="<?= $summary['plan_mc_gloves'] ?> "
                                    class="form-control" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="ttlpersengloves"
                                    value="<?= round(($summary['plan_mc_gloves'] / $summary['mc_gloves']) * 100) ?> %"
                                    class="form-control" readonly>
                ...
                <div class="card equal-height">
                    <div class="card-header" id="area_mc">
                        ...
                        <div class="row text-bold">
                            ...
                            <div class="col-lg-4"> Operator:
                                <input type="number" class="form-control" id="operator<?= $no ?>"
                                    value="<?= $detailArea['operator']; ?>" readonly style="width: 70%">
                            </div>
                            <div class="col-lg-4"> Montir:
                                <input type="text" class="form-control" id="montir<?= $no ?>"
...
<script>
    $(document).ready(function() {
        function updateGlobalValues() {
            ...
            $("#ttlplanninggloves").val(ttlPlanningGloves);
            ...
            $("#ttlplanningsocks").val(ttlPlanningSocks);
