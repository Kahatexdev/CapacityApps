    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " data-color="info" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse h-auto  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link  <?= $active1 ?>" href="<?= base_url($role . '') ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $active4 ?> " href="<?= base_url($role . '/datadeffect') ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $active6 ?> " href="<?= base_url($role . '/planningorder') ?>">
                        ...
                        <span class="nav-link-text ms-1">Planning Order</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="<?= base_url($role . '/planningbooking') ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                        ...
                        <span class="nav-link-text ms-1">Planning Booking</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url($role . '/planningmesin') ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                        ...
                        <span class="nav-link-text ms-1">Plan Area</span>
                    </a>
                </li>
                <li class="nav-item mt-3">
                ...
                <li class="nav-item">
                    <a class="nav-link   " href="<?= base_url('capacity/pph/' . session()->get('username')) ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link   " href="<?= base_url('capacity/retur') ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link   " href="<?= base_url('capacity/po_tambahan/' . session()->get('username')) ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link   " href="<?= base_url('capacity/jatah_bahan_baku') ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="<?= base_url($role . '/cancelBooking') ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                        ...
                        <span class="nav-link-text ms-1">Cancel Booking</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link  " href="<?= base_url($role . '/cancelOrder') ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="<?= base_url($role . '/turunOrder') ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                        ...
                        <span class="nav-link-text ms-1">Turun Order</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link  " href="<?= base_url($role . '/sales') ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                        ...
                        <span class="nav-link-text ms-1">Sales Position</span>
                    </a>
                </li>
