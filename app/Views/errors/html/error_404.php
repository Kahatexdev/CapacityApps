...
<body>
    <?php if (ENVIRONMENT !== 'production') : ?>
        ...
        <code><span>Cek_lagi</span> (<b>routes;controller;model;parameter;</b>) {<span>try_again()</span>;}</code>
        <code><span>Baca coba nih </span> {<em>Pesan Error na:</em>(<i><?= nl2br(esc($message)) ?></i>); }</code>
